import{_ as n,p as s,q as a,a1 as p}from"./framework-efe98465.js";const t={},e=p(`<h1 id="防抖" tabindex="-1"><a class="header-anchor" href="#防抖" aria-hidden="true">#</a> 防抖</h1><p>只在最后一次调用之后过了一段时间再执行，而不是每次事件触发都会立即执行。</p><h3 id="封装函数" tabindex="-1"><a class="header-anchor" href="#封装函数" aria-hidden="true">#</a> 封装函数</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * 函数接受两个参数 
