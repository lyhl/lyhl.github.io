import{_ as n,p as s,q as a,a1 as t}from"./framework-efe98465.js";const p={},e=t(`<h1 id="阻止页面默认返回-app端" tabindex="-1"><a class="header-anchor" href="#阻止页面默认返回-app端" aria-hidden="true">#</a> 阻止页面默认返回(app端)</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token function">onBackPress</span><span class="token punctuation">(</span><span class="token parameter">options</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
