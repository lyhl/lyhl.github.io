import{_ as n,p as e,q as s,a1 as i}from"./framework-efe98465.js";const a={},l=i(`<h4 id="uniapp常用方法封装-vue2" tabindex="-1"><a class="header-anchor" href="#uniapp常用方法封装-vue2" aria-hidden="true">#</a> uniapp常用方法封装（vue2）</h4><blockquote><p>消息提示，数据缓存及图片预览</p></blockquote><h5 id="方法封装" tabindex="-1"><a class="header-anchor" href="#方法封装" aria-hidden="true">#</a> 方法封装</h5><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>//common/too.js 
